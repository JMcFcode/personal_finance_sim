...
year_rent: int = 10  # Years renting out of the house after living at home but before buying a house
...
mortgage_rate: float = 0.075  # Interest rate on mortgage.
mortgage_length: float = 30  # Length of mortgage in years.
